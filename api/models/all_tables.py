...
class Patient(_database.Base):
    ...
    pt_weight = _sql.Column(_sql.Integer, index=True, nullable=True)
    pt_height = _sql.Column(_sql.Integer, index=True, nullable=True)
    pt_pressure = _sql.Column(_sql.Integer, index=True, nullable=True)
